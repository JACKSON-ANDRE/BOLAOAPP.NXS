-- RESTAURAR LÓGICA DE COBRANÇA DA APOSTA
-- O usuário relatou que a aposta não está descontando do saldo.
-- Este script REFAZ a função place_bet com a linha de desconto garantida.
